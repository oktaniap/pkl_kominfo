  ...
  <!-- Menu -->    
      <div class="container" style="width: 60%;border: 10px solid #DCDCDC; margin-top: 2%; border-radius: 10px;font-size: 17px; padding-top: 2%; padding-left: 2%; padding-bottom: 1%;">
        ...
        while ($row=mysqli_fetch_array($query)) {
          ...
          <table><tr>
              <td>Institusi</td>
              <td><?php echo $row['institusi'];?></td></tr>
              <tr>
                <td>Bidang</td>
                <td><?php $bidang=$row['bidang'];
                  if ($bidang=="sekre") {
                     echo "Sekretariat";
                  }if ($bidang=="pds") {
        ...
        ?>
        <h4>Penilaian</h4>
        <form method="POST" action="add_sertifikat_db.php" enctype="multipart/form-data">
          <table>
            <tr>
              <td>No</td>
              <td>Nama</td>
              ...
              <?php
              $sql3="SELECT * FROM pemagang WHERE id_magang='$id_magang'";
              ...
              while ($row3=mysqli_fetch_array($query3)) {
                ...
                <td><?php echo $i++; ?></td>
                <td>
                  <input type="hidden" name="id_pemagang[]" value="<?php echo $row3['id_pemagang'] ?>">
                <?php
                echo $row3['nama'];
                ?>
                </td>
                ...
                <td><input type="file" name="sertif[]"></td>
                </tr>
                <?php
              }
              ?>
          ...
          <button class="btn btn-primary" style="font-weight: bold;">Kirim</button>
        </form>
      </div>
  <!-- Akhir Menu -->
