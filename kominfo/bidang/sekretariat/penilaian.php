      ...
      <div class="container">
        ...
        if ($cek==0) {
          ...
          while ($row=mysqli_fetch_array($query)) {
            ?>
            <div class="container" style="width: 60%;border: 10px solid #DCDCDC; margin-top: 2%; border-radius: 10px;font-size: 17px; padding-top: 2%; padding-left: 2%; padding-bottom: 1%;"><table><tr>
              <td>Institusi</td>
              ...
              <button class="btn btn-primary" style="font-weight: bold; margin-left: 80%;" onclick="window.location.href='add_penilaian.php?id_magang=<?php echo $row['id_magang'];?>'">Nilai</button>
              </tr>
            </div>
            <?php
          }
