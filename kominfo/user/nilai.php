...
<html lang="en">
  ...
  <!-- Menu -->
      ...
      include "../koneksi.php";
      $sql = "SELECT * FROM magang WHERE username='$username' AND status=5";
            ...
            <table>
              <tr>
                ...
                while ($row3=mysqli_fetch_array($query3)) {
                  ...
                  <td>
                  <?php echo $row3['nilai']; 
                  $name3=explode('../dokumen/sertifikat/', $row3['file_sertif']);?>
                  </td>
                  <td><a href="download1.php?file=<?php echo $name3[1]?>" class="btn btn-primary">Download</a></td>
                  </tr>
                  <?php
                }
                ?>
